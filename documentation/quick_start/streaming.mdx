...
Замеры осуществлялись разными людьми нашим бенчмарком на разных устройствах и разных интернет-соединениях.
Вот результаты:
...
<AccordionGroup>
  <Accordion title="Подключение к WebSocket">
    ...
    **Параметры подключения:**
    ...
    |----------|--------------|--------------|----------|
    | `token` | Да | — | API токен для авторизации |
    ...
    **Формат аудио для отправки:**
    ...
    ```json
    {
      ...
      "supported_codecs": ["linear16", "linear32", "flac", "opus", "ogg-opus", "mp3", "aac", "wav"],
